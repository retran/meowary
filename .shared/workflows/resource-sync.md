...
```
node {{AGENT_DIR}}/scripts/confluence-missing.js [SPACE...]
```
...
```
node {{AGENT_DIR}}/scripts/confluence-updates.js <last-sync-date> [SPACE...]
```
...
```
node {{AGENT_DIR}}/scripts/confluence-ingest.js
```
