...
3. RUN `node {{AGENT_DIR}}/scripts/find-backlinks.js resources/<old-path>.md` — show all inbound links.
...
1. RUN `node {{AGENT_DIR}}/scripts/find-backlinks.js resources/<source-path>.md`
...
1. RUN `node {{AGENT_DIR}}/scripts/find-backlinks.js resources/<original-path>.md`
...
1. CONFIRM article.
2. RUN `node {{AGENT_DIR}}/scripts/find-backlinks.js <path>` — show all inbound.
