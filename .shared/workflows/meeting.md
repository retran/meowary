...
2. CREATE from `{{AGENT_DIR}}/skills/journal/meeting-template.md`.
...
- **Today's daily note missing:** Create from `{{AGENT_DIR}}/skills/journal/daily-template.md` before cross-link.
- **`waiting-for.md` missing:** Create from `{{AGENT_DIR}}/meta-templates/waiting-for-template.md` before routing.
