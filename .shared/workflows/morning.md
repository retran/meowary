...
| Daily template | `{{AGENT_DIR}}/skills/journal/daily-template.md` | If creating |
| Weekly template | `{{AGENT_DIR}}/skills/journal/weekly-template.md` | Mondays |
...
- **`recurring-events.md` missing:** Leave Calendar blank. Restore from `{{AGENT_DIR}}/meta-templates/recurring-events-template.md`.
