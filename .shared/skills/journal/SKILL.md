...
<reading_list>
File: `journal/reading-list.md`. If missing, copy from `{{AGENT_DIR}}/meta-templates/reading-list-template.md`.
...
<waiting_for_list>
File: `journal/waiting-for.md`. If missing, copy from `{{AGENT_DIR}}/meta-templates/waiting-for-template.md`.
