...
2. Copy `{{AGENT_DIR}}/skills/projects/project-template.md` → `projects/<slug>/README.md`.
...
7. Create `projects/<slug>/dev-log.md` from `{{AGENT_DIR}}/skills/projects/dev-log-template.md`.
