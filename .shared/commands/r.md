...
<pre_check>
Verify `meta/resources-log.md` exists. If not, copy from `{{AGENT_DIR}}/meta-templates/resources-log-template.md`.
</pre_check>
...
Read `{{AGENT_DIR}}/workflows/<matched>.md`. Execute it. Pass target as input.
