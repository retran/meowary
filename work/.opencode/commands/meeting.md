...
Arguments: `/meeting [project-slug]` -- if a project slug is provided, notes are appended to that project's `meetings.md`. Otherwise, ask the user.
...
If a project slug was provided as `$1`, use that project and skip the project question.
