...
## Step 3: Project and External Check-In
...
- Once the user confirms the daily note is ready, commit all changes with a message like "Add daily note for YYYY-MM-DD" or "Update daily note for YYYY-MM-DD".
